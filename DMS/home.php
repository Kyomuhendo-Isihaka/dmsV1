                ...
                ?>
                                                                                ...
                                                                                <div class="dropdown">
                                                                                    ...
                                                                                    if ($role == 'salesman') {
                                                                                        ...
                                                                                        echo "$fname $lname (Medical Super Intendant )";
                                                                                    }else{
        ...
        <ul class="sideber__ber">
            ...
            <?php if ('admin' == $sessionRole || 'manager' == $sessionRole) { ?>
                                        ...
                                        <li id="left" class="sideber__item sideber__item--modify<?php if ('addPharmacist' == $id) {
                                            ...
                                            <a href="home.php?id=addPharmacist"><i id="left" class="fas fa-user-plus"></i></i>Add
                                                Pharmacist</a>
                                        </li><?php } ?>
            <li id="left" class="sideber__item<?php if ('allPharmacist' == $id) {
                echo " active";
            } ?>">
                <a href="home.php?id=allPharmacist"><i id="left" class="fas fa-user"></i>All Pharmacist</a>
            </li>
                                                                                                    ...
                                                                                                    while ($drug = mysqli_fetch_assoc($result)) {
                                                                                                        ...
                                                                                                        if ($drug['expiry_date'] == $current_time) {
                                                                                                            ...
                                                                                                            mysqli_query($connection, $query);
                                                                                                                                                                        ...
                                                                                                                                                                        <tr>
                                                                                                                                                                            <td><?php printf("%s", $drug['batch_num']); ?></td>
                                                                                        ...
                                                                                        <div class="main__form">
                                                                                            ...
                                                                                            <form action="add.php" method="POST">
                                                                                                ...
                                                                                                <div class="col col-12">
                                                                                                        <label class="input">
                                                                                                        <p id="left">B/N</p>
                                                                                                            <input id="uniqueValue" readonly type="text" class="form-control" name="batch_num"required>
                                                                                                        </label>
                                                                                                    </div>
                    ...
                    $drug = mysqli_fetch_assoc($result); ?>
                            <div class="addManager">
                                <div class="main__form">
                                    ...
                                    <h5 class="mb-3">Batch Number: <?=$drug['batch_num']?></h5>
                                    <div class="row">
